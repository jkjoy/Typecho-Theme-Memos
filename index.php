            ...
            <div class="memos__content" style="--avatar-url: url(<?php echo htmlspecialchars($gravatarUrl); ?>)">
                <div class="memos__text">
                    <div class="memos__userinfo">
                        ...
                        <div class="memos__id">@admin</div><?php if (isset($this->isSticky) && $this->isSticky): ?><?php echo $this->stickyHtml; ?><?php endif; ?>
                    </div>
                    <span class='tag-span'>
                ...
                <div class="memos__meta">
                    <small class="memos__date">
                        ...
                        <!--<a href="<?php //$this->permalink() ?>" target="_blank">阅读全文</a>-->
                    </small>
                </div>
            </div>
        </li>
